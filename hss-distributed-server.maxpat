...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1070.0, 169.0, 61.0, 22.0 ],
					"text" : "list.slice 1"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 141.0, 154.0, 53.0, 22.0 ],
									"text" : "list.nth 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 140.0, 128.0, 147.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 140.0, 100.0, 61.0, 22.0 ],
									"text" : "list.slice 1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.0, 244.134766000000013, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 941.0, 98.0, 19.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1053.0, 55.0, 178.0, 22.0 ],
					"presentation_linecount" : 3,
					"text" : "get DefaultSetting::networkData"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 735.5, 173.0, 50.0, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 719.0, 55.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 719.0, 92.0, 83.0, 22.0 ],
					"text" : "radiogroup $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 719.0, 126.0, 57.0, 22.0 ],
					"text" : "universal"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 603.0, 126.0, 18.0, 18.0 ],
					"size" : 1,
					"value" : 0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 658.0, 179.0, 18.0, 18.0 ],
					"size" : 1,
					"value" : 0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 548.0, 179.0, 18.0, 18.0 ],
					"size" : 1,
					"value" : 0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 658.0, 71.0, 18.0, 18.0 ],
					"size" : 1,
					"value" : 0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 548.0, 71.0, 18.0, 18.0 ],
					"size" : 1,
					"value" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 548.0, 71.0, 128.0, 128.0 ],
					"proportion" : 0.5
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 941.0, 131.0, 148.0, 22.0 ],
					"text" : "route networkData"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 557.0, 743.0, 99.0, 22.0 ],
									"text" : "prepend readNet"
								}
...
, 							{
								"box" : 								{
									...
									"restore" : [ "Macintosh HD:/Users/Shared/Max 8/Library/healing-soundscapes/" ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0,
										"parameter_mappable" : 0
									}
,
									"text" : "pattr @bindto path @thru 0",
									"varname" : "u793060539[3]"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 2,
									"outlettype" : [ "bang", "temp.txt" ],
									"patching_rect" : [ 557.0, 663.0, 120.0, 22.0 ],
									"text" : "t b temp.txt"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 557.0, 717.0, 120.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 720.0, 743.0, 81.0, 22.0 ],
									"text" : "prepend write"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "temp.txt" ],
									"patching_rect" : [ 720.0, 663.0, 120.0, 22.0 ],
									"text" : "t b temp.txt"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 720.0, 717.0, 120.0, 22.0 ],
									"text" : "sprintf symout %s%s"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 137.0, 112.0, 54.0, 22.0 ],
									"text" : "deferlow"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 489.0, 555.0, 100.0, 22.0 ],
									"text" : "prepend writeNet"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "temp.txt" ],
									"patching_rect" : [ 489.0, 475.0, 120.0, 22.0 ],
									"text" : "t b temp.txt"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 489.0, 529.0, 120.0, 22.0 ],
									"text" : "sprintf symout %s%s"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 317.0, 522.0, 42.0, 22.0 ],
									"text" : "t b b b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 230.0, 580.0, 103.0, 22.0 ],
									"text" : "pull_from_coll net"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "dictionary", "", "", "", "" ],
									"patching_rect" : [ 251.0, 626.0, 61.0, 22.0 ],
									"saved_object_attributes" : 									{
										"embed" : 0,
										"legacy" : 0,
										"parameter_enable" : 0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 340.0, 580.0, 35.0, 22.0 ],
									"text" : "clear"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 317.0, 488.0, 151.0, 22.0 ],
									"text" : "t b dump reset"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 531.0, 346.0, 80.0, 22.0 ],
									"text" : "prepend read"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 484.0, 85.0, 67.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 484.0, 43.0, 87.0, 22.0 ],
									"text" : "loadmess path"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 485.5, 312.0, 54.0, 22.0 ],
									"text" : "sel done"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 485.5, 282.0, 110.0, 22.0 ],
									"text" : "route train writeNet"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 309.0, 103.0, 55.0, 22.0 ],
									"text" : "zl.slice 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "", "", "", "", "" ],
									"patching_rect" : [ 137.0, 53.0, 191.0, 22.0 ],
									"text" : "routepass train addPat clear piece"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 142.0, 355.5, 69.0, 22.0 ],
									"text" : "viewsource"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 228.0, 731.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 686.0, 475.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 686.0, 544.0, 83.0, 22.0 ],
									"text" : "t b b l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 786.0, 629.0, 62.0, 22.0 ],
									"text" : "append cr"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 750.0, 603.0, 55.0, 22.0 ],
									"text" : "zl.slice 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "dictionary", "", "", "", "" ],
									"patching_rect" : [ 686.0, 516.0, 61.0, 22.0 ],
									"saved_object_attributes" : 									{
										"embed" : 0,
										"legacy" : 0,
										"parameter_enable" : 0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "bang", "int" ],
									"patching_rect" : [ 786.0, 779.0, 40.0, 22.0 ],
									"text" : "text"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 750.0, 575.0, 47.0, 22.0 ],
									"text" : "dict.iter"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 383.0, 608.0, 45.0, 22.0 ],
									"text" : "t l l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 409.0, 661.0, 29.5, 22.0 ],
									"text" : "- 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 383.0, 690.0, 45.0, 22.0 ],
									"text" : "zl.slice"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 228.0, 370.0, 738.0, 90.0 ],
									"setminmax" : [ 0.0, 1.0 ],
									"size" : 88
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 345.0, 169.0, 738.0, 90.0 ],
									"setminmax" : [ 0.0, 1.0 ],
									"size" : 88
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 409.0, 635.0, 50.0, 22.0 ],
									"text" : "zl.sub #"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 340.0, 690.0, 35.0, 22.0 ],
									"text" : "reset"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "clear" ],
									"patching_rect" : [ 383.0, 739.0, 66.0, 22.0 ],
									"text" : "my-LtoColl"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 383.0, 572.0, 55.0, 22.0 ],
									"text" : "route set"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 383.0, 771.0, 50.5, 22.0 ],
									"saved_object_attributes" : 									{
										"embed" : 0,
										"precision" : 6
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "bang", "int" ],
									"patching_rect" : [ 383.0, 529.0, 40.0, 22.0 ],
									"text" : "text"
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 37.0, 212.0, 407.0, 17.0 ],
													"text" : "2. this will cause an output at the left outlet which is the current response to that input"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 37.0, 193.0, 407.0, 17.0 ],
													"text" : "1. in the left inlet put a list of floats with the same length as the number of inputs"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 25.0, 175.0, 310.0, 20.0 ],
													"text" : "to use the network:"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 49.0, 142.0, 407.0, 17.0 ],
													"text" : "(the right oultet repsonds with \"train done\" when the cycles are complete)"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 38.0, 128.0, 407.0, 17.0 ],
													"text" : "5. send the \"train\" message with an argument specifying the number of training cycles"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 38.0, 114.0, 407.0, 17.0 ],
													"text" : "4. repeat steps 1-3 for each pattern you want to train"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 38.0, 100.0, 407.0, 17.0 ],
													"text" : "3. send in the \"addPat\" message"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 38.0, 74.0, 407.0, 27.0 ],
													"text" : "2. in the right inlet put a list of floats with the same length as the number of outputs and is the desired response to the last input you provided to the left inlet (above)"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 48.0, 61.0, 407.0, 17.0 ],
													"text" : "(this will cause an output at the left outlet which is the current response to that input)"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 74.0, 390.0, 366.0, 37.0 ],
													"text" : "for advanced users the int args may be followed optionally by two float args to specify the training parameters: learning rate (default 0.25) and activation function offset (default 0.01)."
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 74.0, 292.0, 365.0, 17.0 ],
													"text" : "if there are none arguments start with ints as outlined below"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 74.0, 366.0, 365.0, 17.0 ],
													"text" : "the final int arg specifies the number nodes at the output from the network"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 74.0, 341.0, 365.0, 27.0 ],
													"text" : "this may be followed by any number of optional ints specifying the number of nodes in each hidden layer"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 74.0, 328.0, 365.0, 17.0 ],
													"text" : "the first int arg specifies the number of nodes at the inputs to the network"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 74.0, 315.0, 365.0, 17.0 ],
													"text" : "at least two int args are required specifying the network structure"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 74.0, 279.0, 365.0, 17.0 ],
													"text" : "if there is only one this is the network file"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 74.0, 266.0, 365.0, 17.0 ],
													"text" : "if there are two symbol args these are network and pattern files in that order"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 74.0, 253.0, 365.0, 17.0 ],
													"text" : "two optional symbol args to specify network and pattern files to load"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 63.0, 236.0, 329.0, 20.0 ],
													"text" : "args:"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 37.0, 47.0, 407.0, 17.0 ],
													"text" : "1. in the left inlet put a list of floats with the same length as the number of inputs"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 25.0, 29.0, 310.0, 20.0 ],
													"text" : "to train the network:"
												}
...
,
									"patching_rect" : [ 22.0, 585.0, 82.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 27.0, 169.0, 185.0, 33.0 ],
									"text" : "clear everything or init the patterns/network separately"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 240.0, 346.0, 100.0, 17.0 ],
									"text" : "output pattern"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 345.0, 133.0, 80.0, 20.0 ],
									"text" : "target pattern"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 13.0, 400.0, 198.0, 20.0 ],
									"text" : "read and write i/o pattern files"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 25.0, 258.0, 82.0, 22.0 ],
									"text" : "initPatterns"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 25.0, 233.0, 81.0, 22.0 ],
									"text" : "initNetwork"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 10.0, 449.0, 58.0, 22.0 ],
									"text" : "readPat"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 10.0, 424.0, 64.0, 22.0 ],
									"text" : "writePat"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 14.0, 362.0, 56.0, 22.0 ],
									"text" : "readNet"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 13.0, 335.0, 64.0, 22.0 ],
									"text" : "writeNet"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 25.0, 209.0, 42.0, 22.0 ],
									"text" : "clear"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 9.0, 103.0, 84.0, 22.0 ],
									"text" : "train 10000"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 9.0, 76.0, 53.0, 22.0 ],
									"text" : "addPat"
								}
...
, 							{
								"box" : 								{
									"candicane2" : [ 0.447058823529412, 0.780392156862745, 0.984313725490196, 1.0 ],
									"candicane3" : [ 0.290196078431373, 0.411764705882353, 0.713725490196078, 1.0 ],
									"candicane4" : [ 0.43921568627451, 0.619607843137255, 0.070588235294118, 1.0 ],
									"candicane5" : [ 0.584313725490196, 0.827450980392157, 0.431372549019608, 1.0 ],
									"candicane6" : [ 0.733333333333333, 0.035294117647059, 0.788235294117647, 1.0 ],
									...
									"outlettype" : [ "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 228.0, 169.0, 79.0, 90.0 ],
									"setminmax" : [ 0.0, 1.0 ],
									"size" : 2
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 228.0, 282.0, 136.0, 22.0 ],
									"text" : "mxj nnLists 2 88 88",
									"varname" : "nnLists"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 13.0, 313.0, 199.0, 20.0 ],
									"text" : "read and write network files"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 230.0, 131.0, 75.0, 20.0 ],
									"text" : "input pattern"
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 403.0, 561.0, 441.5, 561.0, 441.5, 480.0, 326.5, 480.0 ],
									"source" : [ "obj-10", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 458.5, 723.0, 392.5, 723.0 ],
									"source" : [ "obj-164", 2 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-166", 0 ],
									"midpoints" : [ 349.5, 614.0, 260.5, 614.0 ],
									"source" : [ "obj-167", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 338.0, 574.0, 239.5, 574.0 ],
									"source" : [ "obj-168", 1 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-166", 0 ],
									"midpoints" : [ 326.5, 566.5, 260.5, 566.5 ],
									"source" : [ "obj-168", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 695.5, 614.0, 566.5, 614.0 ],
									"source" : [ "obj-85", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 146.5, 42.0, 146.5, 42.0 ],
									"source" : [ "obj-94", 0 ]
								}
...
,
					"text" : "p machineLearning",
					"varname" : "machineLearning"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 976.0, 224.0, 117.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1169.0, 165.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1117.0, 306.0, 94.0, 79.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1112.0, 202.0, 47.0, 22.0 ],
					"text" : "dict.iter"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1053.0, 26.0, 117.0, 22.0 ],
					"text" : "get DefaultSetting::1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 923.0, 26.0, 122.0, 22.0 ],
					"text" : "read HSSPieces.json"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "dictionary", "", "", "", "" ],
					"patching_rect" : [ 923.0, 69.0, 91.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"legacy" : 0,
						"parameter_enable" : 0,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 349.0, 18.5, 34.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 262.0, 18.5, 33.0, 20.0 ],
					"saved_attribute_attributes" : 					{
						"textcolor" : 						{
							"expression" : "themecolor.theme_textcolor"
						}
...
,
					"patching_rect" : [ 478.0, 224.0, 34.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 462.0, 15.0, 109.0, 27.0 ],
					"text" : "Open Interface",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 74.0, 18.5, 53.0, 20.0 ],
					"saved_attribute_attributes" : 					{
						"textcolor" : 						{
							"expression" : "themecolor.theme_textcolor"
						}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 700.0, 242.0, 137.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 646.0, 249.0, 46.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 299.0, 17.5, 46.0, 22.0 ],
					"text" : "read, 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 700.0, 217.0, 137.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 632.0, 217.0, 56.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 632.0, 282.0, 70.0, 22.0 ],
					"text" : "pvar DJster"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 690.0, 27.0, 137.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 549.0, 24.0, 126.0, 28.0 ],
					"pattrstorage" : "DJster",
					"presentation" : 1,
					"presentation_rect" : [ 129.0, 14.5, 125.0, 28.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "bang", "bang", "" ],
									"patching_rect" : [ 311.0, 94.0, 40.0, 22.0 ],
									"text" : "t b b l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 313.0, 211.0, 38.0, 22.0 ],
									"text" : "zl.reg"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 398.0, 211.0, 38.0, 22.0 ],
									"text" : "zl.reg"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 719.0, 379.0, 90.0, 22.0 ],
									"text" : "prepend param",
									"varname" : "src[1]"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 669.0, 360.0, 24.0, 24.0 ]
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 455.0, 84.0, 157.0, 22.0 ],
													"text" : "loadmess Tutorial.bank.json"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "int" ],
													"patching_rect" : [ 383.5, 84.0, 55.0, 22.0 ],
													"text" : "strippath"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 383.5, 176.0, 80.0, 22.0 ],
													"text" : "prepend read"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "bang" ],
													"patching_rect" : [ 383.5, 51.0, 67.0, 22.0 ],
													"text" : "opendialog"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "", "", "" ],
													"patching_rect" : [ 383.5, 117.0, 148.0, 22.0 ],
													"restore" : [ "Tutorial.bank.json" ],
													"saved_object_attributes" : 													{
														"parameter_enable" : 0,
														"parameter_mappable" : 0
													}
,
													"text" : "pattr bank @autorestore 0",
													"varname" : "bank"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 513.5, 598.0, 62.0, 22.0 ],
													"text" : "$1 7 8 0 4"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 402.5, 598.0, 62.0, 22.0 ],
													"text" : "$1 4 5 0 3"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 282.5, 598.0, 62.0, 22.0 ],
													"text" : "$1 2 3 0 2"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 162.5, 598.0, 62.0, 22.0 ],
													"text" : "$1 1 2 0 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 573.0, 653.0, 82.0, 22.0 ],
													"text" : "prepend bank"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "bang", "" ],
													"patching_rect" : [ 562.5, 372.0, 29.5, 22.0 ],
													"text" : "t b l"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 562.5, 343.0, 63.0, 22.0 ],
													"text" : "route read"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 562.5, 316.0, 46.0, 22.0 ],
													"text" : "route 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 429.5, 218.0, 50.0, 22.0 ],
													"text" : "getkeys"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 472.5, 487.0, 96.0, 22.0 ],
													"text" : "prepend append"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 472.5, 449.0, 47.0, 22.0 ],
													"text" : "zl.iter 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "clear" ],
													"patching_rect" : [ 472.5, 365.0, 47.0, 22.0 ],
													"text" : "t l clear"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 383.5, 8.0, 30.0, 30.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "int", "", "" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 472.5, 566.0, 100.0, 22.0 ],
													"pattrmode" : 1,
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "int", "", "" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 361.5, 566.0, 100.0, 22.0 ],
													"pattrmode" : 1,
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "int", "", "" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 241.5, 566.0, 100.0, 22.0 ],
													"pattrmode" : 1,
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 311.5, 459.0, 94.0, 22.0 ],
													"text" : "prepend symbol"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 311.5, 425.0, 53.0, 22.0 ],
													"text" : "list.nth 2"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 4,
													"outlettype" : [ "", "", "", "" ],
													"patching_rect" : [ 206.5, 501.0, 124.0, 22.0 ],
													"text" : "gate 4"
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "int", "", "" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 121.5, 566.0, 100.0, 22.0 ],
													"pattrmode" : 1,
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 311.5, 365.0, 134.0, 22.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 282.5, 681.0, 112.0, 22.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 205.5, 6.0, 30.0, 30.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 311.5, 8.0, 30.0, 30.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 282.5, 755.0, 30.0, 30.0 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-5", 0 ],
													"midpoints" : [ 436.0, 401.0, 321.0, 401.0 ],
													"source" : [ "obj-18", 1 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-5", 0 ],
													"midpoints" : [ 321.0, 410.0, 321.0, 410.0 ],
													"source" : [ "obj-18", 0 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-6", 0 ],
													"midpoints" : [ 582.5, 731.0, 292.0, 731.0 ],
													"source" : [ "obj-24", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 572.0, 403.0, 645.5, 403.0, 645.5, 205.0, 439.0, 205.0 ],
													"source" : [ "obj-41", 0 ]
												}
...
,
									"patching_rect" : [ 313.0, 309.0, 392.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "", "", "" ],
													"patching_rect" : [ 578.714285714285779, 182.0, 137.0, 22.0 ],
													"restore" : [ 25 ],
													"saved_object_attributes" : 													{
														"parameter_enable" : 0,
														"parameter_mappable" : 0
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 580.0, 273.0, 71.0, 22.0 ],
													"text" : "prepend tail"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "", "", "" ],
													"patching_rect" : [ 531.571428571428555, 124.0, 148.0, 22.0 ],
													"restore" : [ 25 ],
													"saved_object_attributes" : 													{
														"parameter_enable" : 0,
														"parameter_mappable" : 0
...
,
													"text" : "pattr early @autorestore 0",
													"varname" : "early"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 531.571428571428555, 209.0, 82.0, 22.0 ],
													"text" : "prepend early"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "", "", "" ],
													"patching_rect" : [ 484.428571428571502, 93.0, 139.0, 22.0 ],
													"restore" : [ 100 ],
													"saved_object_attributes" : 													{
														"parameter_enable" : 0,
														"parameter_mappable" : 0
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "", "", "" ],
													"patching_rect" : [ 437.0, 412.0, 168.0, 22.0 ],
													"restore" : [ 70 ],
													"saved_object_attributes" : 													{
														"parameter_enable" : 0,
														"parameter_mappable" : 0
...
,
													"text" : "pattr damping @autorestore 0",
													"varname" : "damping"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "", "", "" ],
													"patching_rect" : [ 390.142857142857167, 323.0, 177.0, 22.0 ],
													"restore" : [ 50 ],
													"saved_object_attributes" : 													{
														"parameter_enable" : 0,
														"parameter_mappable" : 0
...
,
													"text" : "pattr bandwidth @autorestore 0",
													"varname" : "bandwidth"
												}
...
,
													"text" : "pattr roomsize @autorestore 0",
													"varname" : "roomsize"
												}
...
,
													"text" : "pattr amount @autorestore 0",
													"varname" : "amount"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "", "", "" ],
													"patching_rect" : [ 248.625, 154.0, 145.0, 22.0 ],
													"restore" : [ 0 ],
													"saved_object_attributes" : 													{
														"parameter_enable" : 0,
														"parameter_mappable" : 0
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "", "", "" ],
													"patching_rect" : [ 201.5, 93.0, 159.0, 22.0 ],
													"restore" : [ 23 ],
													"saved_object_attributes" : 													{
														"parameter_enable" : 0,
														"parameter_mappable" : 0
...
,
													"text" : "pattr spread @autorestore 0",
													"varname" : "spread"
												}
...
,
									"patching_rect" : [ 192.0, 531.0, 51.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 468.5, 125.0, 61.0, 22.0 ],
									"text" : "o.atomize"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 111.0, 608.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 434.0, 379.0, 57.0, 22.0 ],
									"text" : "tosymbol"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 565.0, 608.0, 30.0, 30.0 ]
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 575.0, 730.0, 93.0, 22.0 ],
													"text" : "loadmess 21 63"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 476.0, 730.0, 93.0, 22.0 ],
													"text" : "loadmess 63 21"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 360.399999999999977, 730.0, 100.0, 22.0 ],
													"text" : "loadmess 109 63"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 253.0, 730.0, 100.0, 22.0 ],
													"text" : "loadmess 66 109"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 460.899999999999977, 929.0, 79.0, 22.0 ],
													"text" : "prepend src3",
													"varname" : "src1[4]"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 403.899999999999977, 874.0, 79.0, 22.0 ],
													"text" : "prepend src2",
													"varname" : "src1[3]"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 517.899999999999977, 814.0, 79.0, 22.0 ],
													"text" : "prepend src4",
													"varname" : "src1[2]"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 346.899999999999977, 818.0, 79.0, 22.0 ],
													"text" : "prepend src1",
													"varname" : "src1[1]"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 5,
													"outlettype" : [ "", "", "", "", "" ],
													"patching_rect" : [ 346.899999999999977, 697.0, 247.0, 22.0 ],
													"text" : "route src1 src2 src3 src4"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 346.899999999999977, 944.0, 30.0, 30.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 346.899999999999977, 628.0, 53.0, 22.0 ],
													"text" : "pack i i"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 386.899999999999977, 600.0, 81.0, 22.0 ],
													"text" : "sprintf set %s"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 366.899999999999977, 569.0, 110.0, 22.0 ],
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 346.899999999999977, 510.0, 79.0, 22.0 ],
													"text" : "unpack f f s s"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 346.899999999999977, 477.0, 49.0, 22.0 ],
													"text" : "zl rot -2"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 346.899999999999977, 665.0, 53.0, 22.0 ],
													"text" : "prepend"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 346.899999999999977, 541.0, 117.0, 22.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 227.0, 513.0, 70.0, 22.0 ],
													"text" : "route frame"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 37.0, 575.0, 73.0, 22.0 ],
													"text" : "clip 135 244"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 109.0, 575.0, 67.0, 22.0 ],
													"text" : "clip 18 126"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 50.0, 473.0, 55.0, 22.0 ],
													"text" : "join"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 50.0, 443.0, 46.0, 22.0 ],
													"text" : "zl.reg"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 49.0, 944.0, 30.0, 30.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "bang", "" ],
													"patching_rect" : [ 49.0, 655.0, 29.5, 22.0 ],
													"text" : "t b l"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 4,
													"outlettype" : [ "", "", "int", "int" ],
													"patching_rect" : [ 50.0, 513.0, 78.0, 22.0 ],
													"text" : "unpack s s i i"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "dictionary" ],
													"patching_rect" : [ 49.0, 725.0, 67.0, 22.0 ],
													"text" : "dict.pack *:"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "dictionary" ],
													"patching_rect" : [ 49.0, 693.0, 125.0, 22.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "dictionary" ],
													"patching_rect" : [ 49.0, 621.0, 109.0, 22.0 ],
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-10", 0 ],
													"midpoints" : [ 59.5, 502.5, 236.5, 502.5 ],
													"order" : 0,
													"source" : [ "obj-20", 0 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-20", 1 ],
													"midpoints" : [ 405.899999999999977, 466.5, 95.5, 466.5 ],
													"source" : [ "obj-21", 1 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-19", 0 ],
													"midpoints" : [ 369.899999999999977, 429.0, 59.5, 429.0 ],
													"source" : [ "obj-22", 0 ]
												}
...
,
									"patching_rect" : [ 762.0, 299.0, 62.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "dictionary", "", "", "", "" ],
									"patching_rect" : [ 740.0, 339.0, 61.0, 22.0 ],
									"saved_object_attributes" : 									{
										"embed" : 0,
										"legacy" : 0,
										"parameter_enable" : 0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 718.0, 299.0, 37.0, 22.0 ],
									"text" : "o.dict"
								}
...
, 							{
								"box" : 								{
									...
									"outputs" : 5,
									"parameter_enable" : 0,
									"patching_rect" : [ 192.0, 478.0, 392.0, 34.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "FullPacket" ],
									"patching_rect" : [ 332.0, 158.0, 104.0, 22.0 ],
									"text" : "o.route /player"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "", "", "", "", "" ],
									"patching_rect" : [ 398.0, 249.0, 139.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 398.0, 278.0, 186.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 398.0, 411.0, 55.0, 22.0 ],
									"text" : "join"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 398.0, 349.0, 55.0, 22.0 ],
									"text" : "zl.slice 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 332.0, 125.0, 61.0, 22.0 ],
									"text" : "o.atomize"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "", "", "", "", "FullPacket" ],
									"patching_rect" : [ 311.0, 43.0, 229.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "FullPacket" ],
									"patching_rect" : [ 311.0, 4.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 472.0, 608.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 379.0, 608.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 718.0, 609.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 285.0, 608.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 762.0, 609.0, 30.0, 30.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 407.5, 459.0, 574.5, 459.0 ],
									"source" : [ "obj-11", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-34", 1 ],
									"midpoints" : [ 574.5, 450.5, 574.5, 450.5 ],
									"source" : [ "obj-13", 3 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-34", 0 ],
									"midpoints" : [ 322.5, 277.5, 201.5, 277.5 ],
									"order" : 1,
									"source" : [ "obj-17", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-2", 0 ],
									"midpoints" : [ 814.5, 585.0, 120.5, 585.0 ],
									"source" : [ "obj-42", 1 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-2", 0 ],
									"midpoints" : [ 478.0, 204.0, 120.5, 204.0 ],
									"source" : [ "obj-5", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-2", 0 ],
									"midpoints" : [ 322.5, 374.5, 120.5, 374.5 ],
									"source" : [ "obj-7", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-2", 0 ],
									"midpoints" : [ 201.5, 586.5, 120.5, 586.5 ],
									"source" : [ "obj-91", 0 ]
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 108.0, 173.0, 35.0, 22.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 16.0, 4.0, 143.0, 66.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1169.0, 202.0, 177.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1240.0, 302.0, 134.0, 76.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-28", 0 ],
					"midpoints" : [ 487.5, 311.0, 153.0, 311.0, 153.0, 65.0, 178.5, 65.0 ],
					"source" : [ "obj-32", 0 ]
				}
